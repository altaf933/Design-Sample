...
import com.sa.material.utils.MyRecyclerScroll;
import com.sa.material.utils.Utils;

import java.util.ArrayList;
import java.util.List;


public class FloatingHideActivity extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int ct = 0;
        for (int i = 0; i < Model.data.length * 3; i++) {
