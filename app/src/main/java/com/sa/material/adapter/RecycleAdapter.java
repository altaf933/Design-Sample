package com.sa.material.adapter;
 ...
 */
public class RecycleAdapter extends RecyclerView.Adapter<RecycleAdapter.VersionViewHolder> {
    ...
    public RecycleAdapter(List<String> versionModels) {
        isHomeList = false;
